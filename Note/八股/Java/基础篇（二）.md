...
new 运算符，new 创建对象实例（**对象实例在堆**内存[[基础篇（一）#^142c0b|（见这）]]中），对象引用指向对象实例（**对象引用存放在栈**内存中）。
...
> 
> 这是官方的介绍：[https://openjdk.java.net/jeps/254open in new window](https://openjdk.java.net/jeps/254) 。
